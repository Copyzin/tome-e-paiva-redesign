// Single source of truth for the 5 practice areas.
// Consumed by Navbar dropdown, Specialties grid, /especialidades, and Footer.

export interface SpecialtyAside {
  eyebrow: string;
  title: string;
  body: string;
}
...
export interface Specialty {
  ...
  num: string;
  title: string;
  /** lucide icon name (rendered via astro-icon as `lucide:<iconName>`) */
  iconName: string;
  short: string;
  long: string;
  bullets: string[];
  aside: SpecialtyAside;
}
